locals {
  ...
  oauth_client_id_key     = "<oauth_client_id_key>"     # Insert the key for the secret manager entry with the client ID of your OAuth 2.0 client
  oauth_client_secret_key = "<oauth_client_secret_key>" # Insert the key for the secret manager entry with the client secret of your OAuth 2.0 client
