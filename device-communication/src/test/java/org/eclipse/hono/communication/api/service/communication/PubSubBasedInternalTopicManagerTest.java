...
class PubSubBasedInternalTopicManagerTest {
    ...
    private PubSubBasedInternalTopicManager internalTopicManager;

    PubSubBasedInternalTopicManagerTest() {
    ...
    void setup() {
        ...
        this.internalTopicManager = new PubSubBasedInternalTopicManager(deviceRepositoryMock, commandTopicEventHandler,
    ...
    @Test
    void testOnTenantChanges_ChangeIsUpdate() throws IOException {
    ...
    @Test
    void testOnTenantChanges_tenantIdIsEmpty() throws IOException {
    ...
    @Test
    void testOnTenantChanges_success() throws IOException {
