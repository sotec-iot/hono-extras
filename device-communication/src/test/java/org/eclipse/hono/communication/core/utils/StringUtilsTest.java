...
class StringUtilsTest {
    ...
    @Test
    void isBase64_valid_true() {
        final String string = "This is a test.";
        final String base64 = Base64.getEncoder().encodeToString(string.getBytes());
        Assertions.assertTrue(StringUtils.isBase64(base64));
    }

    @Test
    void isBase64_invalid_false() {
        final String string = "This is a test.";
        Assertions.assertFalse(StringUtils.isBase64(string));
    }
