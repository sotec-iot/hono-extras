...
public class DeviceConfigRepositoryImpl implements DeviceConfigRepository {
    ...
    public Future<Void> updateDeviceAckTime(final DeviceConfigEntity config, final String deviceAckTime) {
        ...
        parameters.put(ApiCommonConstants.DEVICE_ID_CAPTION, config.getDeviceId());
        parameters.put(ApiCommonConstants.TENANT_ID_CAPTION, config.getTenantId());
    ...
    public Future<Void> updateDeviceConfigError(final DeviceConfigInternalResponse configErrorResponse) {
        final Map<String, Object> parameters = new HashMap<>();
        parameters.put(ApiCommonConstants.DEVICE_ID_CAPTION, configErrorResponse.getDeviceId());
        parameters.put(ApiCommonConstants.TENANT_ID_CAPTION, configErrorResponse.getTenantId());
