...
public interface DeviceStateRepository {
    ...
    /**
     * Lists states for a specific device. Result is ordered by version desc.
     *
     * @param deviceId The device id
     * @param tenantId The tenant id
     * @param limit The maximum number of states to get
     * @return A Future with a List of DeviceStates
     */
    Future<List<DeviceState>> listAll(String deviceId, String tenantId, int limit);

    /**
     * Creates a new state and deletes the oldest one if the total number of states in the DB is bigger than the
     * MAX_LIMIT.
     *
